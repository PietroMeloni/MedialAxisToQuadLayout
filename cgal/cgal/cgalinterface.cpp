...
namespace CGALInterface{
    namespace Triangulation{
        ...
        std::vector<std::array<Point2Dd, 3> > triangulate(const std::vector<Point2Dd >& polygon, const std::vector<std::vector<Point2Dd > >& holes) {
    ...
    std::vector<double> SignedDistances::getUnsignedDistances(const std::vector<Pointd>& points, const AABBTree& tree) {
