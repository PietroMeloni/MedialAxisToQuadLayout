...
void DrawableDcel::draw() const {
    DrawableMesh::draw(vertexCoordinates.size()/3, triangles.size()/3, vertexCoordinates.data(), triangles.data(), vertexNormals.data(), vertexColors.data(), triangleNormals.data(), triangleColors.data());
