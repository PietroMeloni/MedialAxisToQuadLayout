...
void BooleansManager::on_makeBox1PushButton_clicked() {
    ...
    min /=10;
    setMesh1(EigenMesh(EigenMeshAlgorithms::makeBox(BoundingBox(Pointd(0,0,0), Pointd(ui->x1SpinBox->value(),ui->y1SpinBox->value(),ui->z1SpinBox->value())), min)));
}
...
void BooleansManager::on_makeBox2PushButton_clicked() {
    ...
    min /=10;
    setMesh2(EigenMesh(EigenMeshAlgorithms::makeBox(BoundingBox(Pointd(0,0,0), Pointd(ui->x2SpinBox->value(),ui->y2SpinBox->value(),ui->z2SpinBox->value())), min)));
}
